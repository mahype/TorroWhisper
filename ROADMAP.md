...
|---|---|---|---|
| **0 — Stabilität & Logging** | Bug-Fixes + Logging-Infrastruktur, bevor die großen Refactors starten | [#11](https://github.com/mahype/donny/issues/11), [#12](https://github.com/mahype/donny/issues/12) | ◐ (PR [#18](https://github.com/mahype/donny/pull/18)) |
| **1 — LLM-Fundament** | Zentrales LLM-Modell-Management (Provider-Abstraktion, Cloud, Registry) **+** Ollama/LM-Studio-Modelle wiederverwenden | [#14](https://github.com/mahype/donny/issues/14) + [#6](https://github.com/mahype/donny/issues/6) | ☐ |
| **2 — Nachbearbeitungs-Pipeline** | Geordnete, konfigurierbare Stages mit Context (Laravel-Style) | [#16](https://github.com/mahype/donny/issues/16) | ☐ |
| **3 — Plugin-System** | Extension-Points, Plugin-Übersicht & Konfig-Dialoge (Phase 1 intern) | [#15](https://github.com/mahype/donny/issues/15) | ☐ |
| **4 — Chat-Plugin** | KI-Voice-Chat (Sprache → LLM → TTS, Streaming) — erstes Plugin | [#17](https://github.com/mahype/donny/issues/17) | ☐ |
| **Querschnitt** | Accessibility / WCAG 2.1 (A/AA) — separat einplanbar, blockiert nichts | [#10](https://github.com/mahype/donny/issues/10) | ☐ |
...
### Idee
Donny bekommt eine zweite Hauptfunktion neben dem Diktat: einen **Chat-Modus** mit eigenem, frei konfigurierbarem Shortcut. Statt den transkribierten Text in die aktive App einzufügen, spricht der User mit einer KI und bekommt eine **gesprochene Audio-Antwort**.
...
### Idee
Wenn der User den eingefügten Text **direkt nach dem Diktat** im Eingabefeld ändert, soll Donny diese Änderung erkennen, lernen und beim nächsten Mal automatisch anwenden — eine wachsende Form des Dictionary aus Punkt 2, aber **automatisch befüllt**.
...
- Kein Live-Beobachten, sondern: **manueller Lern-Shortcut** ("Mark last as correction") — User markiert nach manueller Korrektur, Donny holt sich den letzten Insert + den aktuellen Eingabefeld-Inhalt, schlägt Dictionary-Eintrag vor.
