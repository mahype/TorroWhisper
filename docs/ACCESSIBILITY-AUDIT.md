# WCAG 2.1 Accessibility Audit — Open Whisper (macOS)
...
`AppDelegate.swift` (`statusImage()`): `megaphone` vs. `megaphone.fill`, `accessibilityDescription` immer „Open Whisper".
- VoiceOver-Nutzer hören nie, ob Aufnahme läuft.
- **WCAG:** 1.4.1 (Use of Color/visuell allein, A), 4.1.2 (A)
- **Fix:** Description zustandsabhängig setzen („Open Whisper — Aufnahme läuft"), Tooltip ebenso.
