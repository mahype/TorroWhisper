...
cargo build -p donny-bridge -p donny-llm-helper
...
export OW_LLM_HELPER="$repo_root/target/debug/donny-llm-helper"

swift run --package-path apps/donny-macos Donny
