...
struct SettingsView: View {
    ...
    var body: some View {
        NavigationSplitView(columnVisibility: $columnVisibility) {
            ...
            .alert(
                ...
                Text("This removes Donny from the Accessibility list so you can add it again. You will need to re-grant access afterwards.", bundle: .module)
            }
        }
    ...
    private var startupContent: some View {
        ...
        Section {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("Changes take effect after restarting Donny.", bundle: .module)
            }
            .font(.caption)
            .foregroundStyle(.secondary)
        }
    ...
    private var helpContent: some View {
        Section {
            ...
            Text("About Donny", bundle: .module)
        }
        ...
        Section {
            ...
            Text("If text insertion stops working even though Donny is listed under Accessibility, reset the permission and add the app again.", bundle: .module)
        }
        ...
        Section {
            Text("Donny writes events and errors to a log file. Attach it when reporting problems.", bundle: .module)
                .font(.callout)
                .foregroundStyle(.secondary)
    ...
    private func openReleaseNotes() {
        guard canOpenReleaseNotes,
              let url = URL(string: "https://github.com/mahype/donny/releases/tag/v\(appVersionString)")
        else { return }
