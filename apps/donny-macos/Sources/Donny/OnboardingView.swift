...
struct OnboardingView: View {
    ...
    private var permissionWarningMessageKey: LocalizedStringKey {
        ...
        if microphoneMissing && accessibilityMissing {
            return "Without microphone and accessibility access, Donny cannot record dictation or insert text into other apps. Do you really want to continue?"
        }
        if microphoneMissing {
            return "Without microphone access, Donny cannot record your dictation. Do you really want to continue?"
        }
        return "Without accessibility access, Donny cannot insert the transcribed text into other apps. Do you really want to continue?"
    }
    ...
    private var currentStep: some View {
        ...
        case 2:
            ...
            Section {
                ...
                Text("Needed so Donny can type the transcribed text into other apps.", bundle: .module)
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
