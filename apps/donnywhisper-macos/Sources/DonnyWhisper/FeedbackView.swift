...
struct FeedbackView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("Thanks for helping make DonnyWhisper better. Pick a channel:", bundle: .module)
                    .font(.callout)
    ...
    private func openGitHubIssues() {
        guard let url = URL(string: "https://github.com/mahype/DonnyWhisper/issues") else { return }
