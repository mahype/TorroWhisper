...
struct SettingsView: View {
    ...
    var body: some View {
        NavigationSplitView(columnVisibility: $columnVisibility) {
            ...
            .alert(
                ...
                Text("This removes DonnyWhisper from the Accessibility list so you can add it again. You will need to re-grant access afterwards.", bundle: .module)
            }
        }
    ...
    private var startupContent: some View {
        ...
        Section {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("Changes take effect after restarting DonnyWhisper.", bundle: .module)
            }
            .font(.caption)
            .foregroundStyle(.secondary)
        }
    ...
    private var helpContent: some View {
        Section {
            ...
            Text("About DonnyWhisper", bundle: .module)
        }
        ...
        Section {
            ...
            Text("If text insertion stops working even though DonnyWhisper is listed under Accessibility, reset the permission and add the app again.", bundle: .module)
        }
        ...
        Section {
            Text("DonnyWhisper writes events and errors to a log file. Attach it when reporting problems.", bundle: .module)
                .font(.callout)
                .foregroundStyle(.secondary)
    ...
    private func openReleaseNotes() {
        guard canOpenReleaseNotes,
              let url = URL(string: "https://github.com/mahype/DonnyWhisper/releases/tag/v\(appVersionString)")
        else { return }
