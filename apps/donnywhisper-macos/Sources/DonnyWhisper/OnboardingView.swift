...
struct OnboardingView: View {
    ...
    private var permissionWarningMessageKey: LocalizedStringKey {
        ...
        if microphoneMissing && accessibilityMissing {
            return "Without microphone and accessibility access, DonnyWhisper cannot record dictation or insert text into other apps. Do you really want to continue?"
        }
        if microphoneMissing {
            return "Without microphone access, DonnyWhisper cannot record your dictation. Do you really want to continue?"
        }
        return "Without accessibility access, DonnyWhisper cannot insert the transcribed text into other apps. Do you really want to continue?"
    }
    ...
    private var currentStep: some View {
        ...
        case 0:
            Section {
                ...
                Text("DonnyWhisper", bundle: .module)
            }
        ...
        case 2:
            ...
            Section {
                ...
                Text("Needed so DonnyWhisper can type the transcribed text into other apps.", bundle: .module)
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
