#ifndef DONNYWHISPER_BRIDGE_FFI_H
#define DONNYWHISPER_BRIDGE_FFI_H
...
char *ow_test_hermes_agent(const char *request_json);
...
char *ow_chat_send_text(const char *request_json);
...
char *ow_tts_piper_voices(void);
char *ow_tts_local_ready(const char *request_json);
char *ow_tts_local_prepare(const char *request_json);
