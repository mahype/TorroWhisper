...
pub const DEFAULT_PIPER_VOICE: &str = torrowhisper_core::DEFAULT_PIPER_VOICE;

/// Generous timeout for the one-time asset downloads (CLI ~25 MB, model ~110 MB).
const DOWNLOAD_TIMEOUT: Duration = Duration::from_secs(600);

/// `~/Library/Application Support/com.gettorro.TorroWhisper/tts`.
fn tts_dir() -> Result<PathBuf, String> {
    ProjectDirs::from("com", "gettorro", "TorroWhisper")
