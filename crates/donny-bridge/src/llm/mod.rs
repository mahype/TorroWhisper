...
//! themselves. The local GGUF backend runs in the existing `donny-llm-helper`
...
use donny_core::{AppSettings, CustomLlmSource, LlmBackendKind, LlmModelRef, LlmPreset};
use reqwest::blocking::Client;

use crate::{llm_model_manager, local_llm};

/// User-Agent sent on remote/cloud provider HTTP calls.
pub(crate) const USER_AGENT: &str = "donny-bridge/0.1";
